  ...
  return (
    ...
    <div className='grid md:grid-cols-2 max-w-[1240px] m-auto'>
      ...
      <div className='flex flex-col justify-center px-2'>
        ...
        <p className='text-[13px] leading-[30.8px] max-w-[470px] mt-5 italic'>체력 4700 방어력 329, 마저 201인 챔피언이 저지불가, 쉴드, 벽 넘기는 거 있고요 에어본 있고 심지어 쿨타임은 1초밖에 안 되고 마나는 15 들고 (따봉) W는 심지어 변신하면 쿨 초기화에다가 패시브는 고정피해가 들어가며 방마저를 올리면 올릴수록 스킬 가속이 생기고 Q에 스킬 가속이 생기고 스킬 속도도 빨라지고 그 다음에 공격력 계수가 있어가지고 W가</p>
